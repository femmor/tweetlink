...
function App() {
  ...
  return (
    <Box>
      <Box pt="20" px="4">
        <Text fontSize={title_size} className="title">
          Tweet Link
        </Text>
      </Box>
      <Box my="12" align="center">
        <form onSubmit={fetchTweet}>
          <InputGroup maxW="90vw">
            <Input name="tweetURL" placeholder="https://twitter.com/fegomson" />
            <InputRightElement>
            ...
            <div className="container" style={{ transform: `scale(${scale})` }}>
              {hint ? (
                <Box className="non-tweet">
                  <Text>
                    Please paste the URL of your tweet in the box above
                  </Text>
                </Box>
              ) : loading ? (
                <Box className="non-tweet">
              ...
              <Flex name="bg" wrap="wrap">
                {gradients.map(g => (
                  <div
                    key={g}
                    style={{
                      border: bg === g ? '2px solid #777' : null,
                      background: g,
                      width: '29px',
                      height: '29px',
                      marginRight: '1rem',
      ...
      <footer>
        <Text color="gray.500" fontSize="lg">
          Made with ❤️ by{' '}
          <a href="https://github.com/femmor" target="_blank" rel="noreferrer">
            Femmy
          </a>
          .
        </Text>
